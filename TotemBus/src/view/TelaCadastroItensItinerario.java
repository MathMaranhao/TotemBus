...
public class TelaCadastroItensItinerario extends javax.swing.JFrame {
     ...
     */
    public boolean validarSeItemJaCadastrado(ModelItemItinerario itemItinerario) {

        if (controllerItemItinerario.verificaSeItemJaCadastradoController(itemItinerario) == true) {
            JOptionPane.showMessageDialog(this, "Esse item já foi cadastrado anteriormente", "Erro", JOptionPane.ERROR_MESSAGE);
            return true;
        } else {
            return false;
        }
    ...
    public boolean verificaItemExiste(ModelItemItinerario itemItinerario) {
    ...
    private void btnCadastrarItemItinerarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarItemItinerarioActionPerformed
        ...
        if (validarCampoIdParaCadastro() == true && validarCampoDescricao() == true && validarCampoTipo() == true) {
            ...
            if (!validarSeItemJaCadastrado(ModelItemItinerario)) {
