...
public class TelaCadastroItensItinerario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLimpar.setBackground(new java.awt.Color(88, 153, 157));
        btnLimpar.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnLimpar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/ImgBtnLimpar.png"))); // NOI18N
        ...
        jButton4.setBackground(new java.awt.Color(88, 153, 157));
        jButton4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/ImgBtnPesquisar.png"))); // NOI18N
    ...
    private void btnCadastrarItemItinerarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarItemItinerarioActionPerformed
        ...
        else if (jtfDescricao.getText().isEmpty() || cbxTipoItemItinerario.getSelectedItem().equals("Selecione")) {
            JOptionPane.showMessageDialog(this, "Favor informar um valor valido", "Erro", JOptionPane.ERROR_MESSAGE);
        } else{
    ...
    private void btnAlterarItemItinerarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarItemItinerarioActionPerformed
        ...
        if(!jtfId.getText().isEmpty()){
            ...
            if(jtfDescricao.getText().isEmpty() || cbxTipoItemItinerario.getSelectedItem().equals("Selecione")){
               ...
               controllerItemItinerario.atualizarItemItinerario(id, ModelItemItinerario);
               carregarItensItinerario();
               limparItensDeCadastro();
            }
